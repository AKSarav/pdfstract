...
const config: Config = {
  ...
  organizationName: 'aksarav', // Usually your GitHub org/user name.
  projectName: 'pdfstract', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/aksarav/pdfstract/tree/main/docs/',
